...
namespace Microsoft.CodeAnalysis.CSharp.Emit
{
    internal sealed class PEDeltaAssemblyBuilder : PEAssemblyBuilderBase, IPEDeltaAssemblyBuilder
    {
        ...
        public PEDeltaAssemblyBuilder(
            ...
            : base(sourceAssembly, emitOptions, outputKind, serializationProperties, manifestResources, default(DebugDocumentPathNormalizer), additionalTypes: ImmutableArray<NamedTypeSymbol>.Empty)
        {
